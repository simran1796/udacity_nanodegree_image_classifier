...
def parse_args():
    ...
    par.add_argument('--arch', dest='arch', default='densenet121', choices=['vgg13', 'densenet121'])
    par.add_argument('--learning_rate', dest='learning_rate', default='0.001')
    par.add_argument('--hidden_units', dest='hidden_units', default='512')
    par.add_argument('--epochs', dest='epochs', default='3')
